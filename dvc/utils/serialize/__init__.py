...
from ._config import *  # noqa, pylint: disable=wildcard-import
...
LOADERS.update(
    {".toml": load_toml, ".json": load_json, ".py": load_py, ".cfg": load_config}  # noqa: F405
)
...
DUMPERS.update(
    {".toml": dump_toml, ".json": dump_json, ".py": dump_py, ".cfg": dump_config}  # noqa: F405
)
